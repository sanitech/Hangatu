...
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="../../assets/assets/assets/" data-template="vertical-menu-template-free">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2 " style="display: flex; flex-direction:column;">
                <div class="app-brand-logo demo">
                  <img src="../assets/images/download__2_-removebg-preview-142x142.png" alt="" width="50">
                </div>
                <span class="app-brand-text demo text-body fw-bold" style="text-transform: uppercase;">Hangatu</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-2">Welcome to Hangatu ! 👋</h4>
            <p class="mb-4">Please sign-in to your account and start the adventure</p>

            <form id="formAuthentication" class="mb-3" action="../backend/loginController.php" method="post" enctype="multipart/form-data">
              <div class="mb-3">
